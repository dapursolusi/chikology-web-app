...
const stressLevels: Record<StressTier, StressLevel> = {
  1: {
    ...
    ciri: 'Ekspresi wajah tampak rileks/netral/positif, kontak mata stabil, otot wajah tidak tegang, gerakan spontan.',
    risiko: 'Hampir tidak ada, kondisi optimal.',
  },
  2: {
    tier: 2,
    ...
    ciri: 'Sedikit ketegangan di wajah (kening, alis, mata), mulai muncul gelisah ringan, senyum berkurang, perhatian sedikit terdistraksi.',
    risiko: 'Jika terus berlanjut, bisa naik ke level moderat.',
  },
  3: {
    tier: 3,
    ...
    ciri: 'Ekspresi tegang (rahang kaku, alis mengerut), microexpression takut/marah,开始terlihat lelah, frustrasi.',
  ...
  4: {
    ...
    ciri: 'Wajah sangat tegang, ekspresi rigid/kaku, asimetri wajah jelas, microexpression negatif (jelas marah/takut), kontak mata menghindar, sulit fokus.',
    risiko: 'Burnout awal, konflik interpersonal.',
  },
  5: {
    tier: 5,
    ...
    ciri: 'Wajah menunjukkan distress tinggi (takut, sedih, panik/disosiatif, marah), gerakan mikro sangat cepat atau beku, asimetri ekstrem, tatapan kosong atau liar, kontrol wajah hilang.',
    risiko: 'Burnout berat, anxiety disorder/depresi (jika kronis).',
  },
};
