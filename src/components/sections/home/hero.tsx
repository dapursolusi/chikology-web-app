...
export function Hero({ ebookLive }: Props) {
  ...
  return (
    <section className="relative overflow-hidden section-padding bg-gradient-subtle">
      {/* Decorative background elements */}
      <div className="absolute inset-0 -z-10 opacity-30">
        <div className="absolute top-20 left-10 h-72 w-72 rounded-full bg-primary/10 blur-3xl" />
        <div className="absolute right-10 bottom-20 h-96 w-96 rounded-full bg-secondary/20 blur-3xl" />
      </div>
      ...
      <div className="mx-auto w-full max-w-6xl px-4 md:px-8">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-6 text-sm text-muted-foreground md:text-base">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-foreground">320K+</span> followers
          </div>
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="font-medium text-foreground">200K+</span> followers
          </div>
        </div>
